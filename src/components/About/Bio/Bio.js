...
const Bio = () => {
  return (<article className="dib w-80 pt3 pa2">
    ...
    <p className="measure lh-copy f3 w-100 white mt0 center pt2-m pt2-ns">I am crypto enthusiast who has some knowledge in the space. I strongly recommend you do your own research before investing into anything.</p>
