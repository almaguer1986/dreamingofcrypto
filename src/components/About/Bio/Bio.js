...
const Bio = () => {
  return (<article className="dib w-80 pt3 pa2">
    ...
    <p className="measure lh-copy f3 w-100 white mt0 center pt2 mt3">Hi, My name is <a className="link theme underline" target="_blank" href="https://www.linkedin.com/in/arturoalmaguer86">Art</a>. I created this site to help those new to the crypto space get started quickly and safely.</p>
