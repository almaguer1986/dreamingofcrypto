...
const Algebraix = () => {
  return (<article className="center mw5 mw6-ns br3 hidden ba b--black-40 bw3 shadow-5 mv4">
    ...
    <a href="https://algebraix.io/" target="_blank" className="w-25"><img src={alx} alt={"alx"} className="h1 h2-m h2-l mt2-m mt2-l mt3 pt0-ns pt1-m pt1-l"/></a>
    </div>
    ...
    <div className="pa3 white">
      ...
      <p className="f6 f5-ns lh-copy tl measure">
        Android -
        <a className="link theme dim underline pl1" target="_blank" href="https://algebraix.io/beta/">ALX Beta Phase II Download</a>
      </p>
      <p className="f6 f5-ns lh-copy tl measure">
