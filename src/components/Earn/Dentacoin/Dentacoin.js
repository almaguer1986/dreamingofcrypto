  ...
  return (<article className="center mw5 mw6-ns br3 hidden ba b--black-40 bw3 shadow-5 mv4">
    ...
    <div className="pa3 white">
      ...
      <p className="f6 f5-ns lh-copy tl measure">
        Current Price :
        <a className="link theme dim underline pl1" href="https://coinmarketcap.com/currencies/dentacoin/">Found Here</a>
      </p>
      <p className="f6 f5-ns lh-copy tl measure">
      ...
      <p className="f6 f5-ns lh-copy tl measure">
        Android -
        <a className="link theme dim underline pl1" href="https://play.google.com/store/apps/details?id=com.dentacoin.dentacare&hl=en">Download Dentacare Android</a>
      </p>
      <p className="f6 f5-ns lh-copy tl measure">
