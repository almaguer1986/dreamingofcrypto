  ...
  return (<article className="center mw5 mw6-ns br3 hidden ba b--black-40 bw3 shadow-5 mv4">
    ...
    <div className="pa3 white">
      ...
      <p className="f6 f5-ns lh-copy tl measure">
        Current Price :
        <a className="link theme dim underline pl1" href="https://coinmarketcap.com/currencies/storm/">Found Here</a>
      </p>
      <p className="f6 f5-ns lh-copy tl measure">
      ...
      <p className="f6 f5-ns lh-copy tl measure">
        Android -
        <a className="link theme dim underline pl1" href="https://goo.gl/U4c1GJ">Download Storm Play Android</a>
      </p>
      <p className="f6 f5-ns lh-copy tl measure">
