...
const Sweatcoin = () => {
  return (<article className="center mw5 mw6-ns br3 hidden ba b--black-40 bw3 shadow-5 mv4">
    ...
    <div className="pa3">
      ...
      <p className="f6 f5-ns lh-copy tl measure white">
        Android -
        <a className="link theme dim underline pl1" href="https://sweatco.in/hi/arturo172183">Download Sweatcoin for Android</a>
      </p>
      <p className="f6 f5-ns lh-copy tl measure white">
        ios -
        <a className="link theme dim underline pl1" href="https://sweatco.in/hi/arturo172183">Download Sweatcoin for ios</a>
      </p>
